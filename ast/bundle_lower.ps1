# Bundle the lower-milestone subject: everything the check milestone
# carries, plus lowering and its type helpers. Output: lower-subject.codex
# next to this script.
#
...
param(
    [string]$Harness = 'LowerHarness.codex',
    [string]$OutName = 'lower-subject.codex'
)
...
Bundle-PlugSource -PreLines $preLines -Lines $lines -BundleSrc (Join-Path $here $OutName) -PlugName 'lower-subject'
