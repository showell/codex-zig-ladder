#!/usr/bin/env python3
"""Generate LowerHarness.codex: the check harness plus one more phase --
it lowers the checked chapter to IR and dumps the IRChapter. The dump
...
(HERE / 'LowerStubs.codex').write_text(text)
print(f'{HERE / "LowerStubs.codex"}: real chapter minus {stripped} bs-emit references')
